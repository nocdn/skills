...
description: generate a commit message that matches the repository's existing style by inspecting recent commit subjects and the current staged or unstaged changes. use when the user asks for a commit message, git commit text, or help summarizing current changes.
---
...
4. Draft a commit message that matches that style and accurately reflects the current changes.
